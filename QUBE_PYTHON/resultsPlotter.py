...
def speedPlotwithCurrentObs(fileName, Title, Start = 100, Stop=10000):
...
#speedPlotwithCurrentObs(fileName, title, 6000, 10000)
...
#anglePlotwithCurrent(fileName, title, 6000, 10000)
